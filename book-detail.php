...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary"><?php echo $_GET['subject']; ?></h2>
        </div>
        <?php 
        include 'db.php';
            $a = $_GET['subject'];
...
$sql = mysqli_query($conn,$sql1);
        ...
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
               <?php  echo "<img src='img/icon.jpg' alt='Image' class='img-fluid'>" ?>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <?php
                            ...
                            $download = 'download?file='.$a.'#toolbar=0';
                            //echo $download;
                    ?>
                        ...
                         
                            ...
                            <input type="hidden" id="namafile" name="namafile" value="<?php echo $a; ?>">
                    ...
                    <div class="mb-4 d-flex flex-wrap">
                        ...
                        <div class="mr-4 mb-2">
                            <span class="tm-text-gray-dark">Format:</span><span class="tm-text-primary">PDF</span>
                        </div>
                    </div>
                    <div class="mb-4">
