...
// $poli = $_GET['poli'];
// if($poli == "File Kepegawaian")
// {
//     header("location:poli");
//     // header("Location:login");  
// }
        $poli = $_GET['poli'];
    $sql = mysqli_query($conn,"select * from dokumen where poli='$poli'");
...
<body>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/logo2.png">
        <form class="d-flex tm-search-form">
            <input class="form-control tm-search-input" type="search" id="myInput" name="myInput" placeholder="Search" aria-label="Search">
            <button onclick = "kirim()" class="btn btn-outline-success tm-search-btn" type="submit" name="submit" >
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <?php if (isset($_GET['page'])){
                ...
                if($a==1)
            {
                $range1 = $a;
                $range2 = $a * 16;
                $qry1 = "select * from dokumen where poli = '$poli'
                         limit 0,$range2";
                //echo $qry1;
            ...
            if($a>1)
            {
                ...
                $range2 = $a *16;
                $range1 = $range2 - 16;
                $qry2 = "select * from dokumen where poli = '$poli'
                                          limit $range1,$range2";
                $sql1=mysqli_query($conn,"select * from dokumen where poli = '$poli'
                                          limit $range1,$range2");
                //echo $qry2;
            }
        	...
        	<div class='col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-5'>
                <figure class='effect-ming tm-video-item'>
                    <img src='img/folder.jpg' alt='Image' class='img-fluid'>
                    <figcaption class='d-flex align-items-center justify-content-center'>
                        <h2><b>".$files1[$i]."</b></h2>
                        <a href='index3?subject=$files1[$i]&poli=$poli&page=1'>View more</a>
                    </figcaption>                    
                </figure>
                <div class='d-flex justify-content-between tm-text-gray'>
                    <span class='tm-text-black-light'>".$files1[$i]."</span>
                    <span></span>
                </div>
            </div>";
        }
        ...
        <div class="row tm-mb-90">
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                ...
                echo "<a href='index?page=$previous&poli=$poli' class='btn btn-primary tm-btn-prev mb-2'>Previous</a>";
            }
                ...
                <div class="tm-paging d-flex">
                    ...
                    for($i=1;$i<=$b;$i++)
                    {
                    echo "<a href='index?page=$i&poli=$poli' class='active tm-paging-link'>$i</a>";
                    }
                ...
                echo "<a href='index?page=$next&poli=$poli'  class='btn btn-primary tm-btn-next'>Next Page</a>";
               }
                ?>
            </div>            
        </div>
