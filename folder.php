...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-2" href="http://192.168.214.191:8887/download/Dokumen KEPERAWATAN.zip/">Dokumen Keperewatan</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-3" href="http://192.168.214.191:8887/download/Dokumen NAKESLA.zip/">Dokumen Nakesla</a>
                </li>
                <!-- <li class="nav-item">
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <?php 
                $qry2 = "select home,logo from home
                          ;";
        	...
        	<div class='col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-5'>
                <figure class='effect-ming tm-video-item'>
                    ...
                    <figcaption class='d-flex align-items-center justify-content-center'>
                        <h2><b>".$row['home']."</b></h2>
                        <a href='sub-folder?home=$home&page=1'>View more</a>
                    </figcaption>                    
                </figure>
                <div class='d-flex justify-content-between tm-text-gray'>
                    <span class='tm-text-black-light'>".$row['home']."</span>
                    <span></span>
                </div>
            </div>";
                  }  
        ...
        <div class="row tm-mb-90">
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                ...
                echo "<a href='index?page=$previous' class='btn btn-primary tm-btn-prev mb-2'>Previous</a>";
            }
                ...
                echo "<a href='index?page=$next'  class='btn btn-primary tm-btn-next'>Next Page</a>";
               }
                ?>
            </div>            
        </div>
