...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary"><?php echo $dokumen; ?></h2>
        </div>
        <?php 
        include 'db.php';
            $a = $_GET['dokumen'];
...
// $sql1 = "select * from dokumen where namafile = '$a';";
...
$poli = $_GET['poli'];
            ...
            $dir    = 'D:/File_Dok_Lib/poli/'.$poli.'/'.$nama.'/';
            $files1 = scandir($dir);
...
else
{
 ...
 $dir = 'D:/File_Dok_Lib/poli/'.$poli.'/'.$nama.'/'.$img_type.'';
//$dir = 'http://192.168.214.191:8887/tolong/'.$poli.'/'.$nama.'/'.$img_type.'';
//$dir = 'http://192.168.214.252/poli/'.$poli.'/'.$nama.'/'.$img_type.'';
echo $dir;
        ?>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
               <?php  echo "<img src='".$dir."' alt='Image' class='img-fluid' width='200' height='200'>"; ?>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    $nama = $_GET['nama'];
                            ...
                            $download = 'download2?poli='.$poli.'&nama='.$nama.'&dokumen='.$a.'#toolbar=0';
                            //echo $download;
                    ?>
                        ...
                         
                            ...
                            <form id = "theform" action = 'insert.php' method = "POST">
                                <input type="hidden" id="counter" name="counter" value="1">
                            <input type="hidden" id="namafile" name="namafile" value="<?php echo $dokumen; ?>">

                            </form> 
                    <button onclick="JavaScript:window.location.href='<?php echo $download; ?>';" type="button"  class="btn btn-rounded btn-danger">                                                    
                                                     
                                                    <span class="btn-icon-left text-primary"><i
                                                class="fa fa-view color-warning"></i> </span>View</button>
                                                       
                    <div class="mb-4 d-flex flex-wrap">
                        <div class="mr-4 mb-2">
                                                            
                            <!-- <span class="tm-text-gray-dark">View: </span><span class="tm-text-primary"> <?php //echo $jumlah_view; ?></span> -->
                        </div>
                        <div class="mr-4 mb-2">
